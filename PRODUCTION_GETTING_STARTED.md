# Moved: Production Getting Started
...
2. **[PRODUCTION_EXTRACTION_MANIFEST.json](./PRODUCTION_EXTRACTION_MANIFEST.json)**
   - Machine-readable file catalog
   - Validation rules  
   - Template definitions
   - Production checklist

3. **[AGENT_WORKFLOW_EXTRACTION.md](./AGENT_WORKFLOW_EXTRACTION.md)**
   - Detailed extraction documentation
   - File mapping reference
   - Directory structures
   - Integration patterns

4. **[AGENT_EXTRACTION_QUICK_REF.md](./AGENT_EXTRACTION_QUICK_REF.md)**
...
```bash
# Read this first
cat PRODUCTION_IMPLEMENTATION_GUIDE.md | head -100
...
cat AGENT_WORKFLOW_EXTRACTION.md
cat PRODUCTION_EXTRACTION_MANIFEST.json | python -m json.tool
...
**See PRODUCTION_IMPLEMENTATION_GUIDE.md for more troubleshooting.**
...
- `PRODUCTION_IMPLEMENTATION_GUIDE.md` - Complete guide (600+ lines)
- `PRODUCTION_EXTRACTION_MANIFEST.json` - File catalog
- `AGENT_WORKFLOW_EXTRACTION.md` - Extraction docs
- `AGENT_EXTRACTION_QUICK_REF.md` - Quick ref
- `PRODUCTION_STATUS.json` - After running status.py
- `production_status.py` - Status verification
...
**Questions?** See PRODUCTION_IMPLEMENTATION_GUIDE.md

**Issues?** Check troubleshooting section in PRODUCTION_IMPLEMENTATION_GUIDE.md

**Want to customize?** Read PRODUCTION_EXTRACTION_MANIFEST.json and the source code of individual scripts.
